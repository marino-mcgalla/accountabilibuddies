...
import 'features/challenge/providers/multi_party_challenge_provider.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        // Set up MultiPartyChallengeProvider
        ChangeNotifierProvider<MultiPartyChallengeProvider>(
          create: (context) => MultiPartyChallengeProvider(),
        ),
      ],
